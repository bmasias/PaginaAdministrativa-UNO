<?php 
  ...
  if ($_SESSION["estado"] == "LOGEADO"){ 
     ...
     $idNosotros = $_GET['id'];
    $sql = "SELECT * FROM clientes WHERE estado='Activo' AND  id='$idNosotros'";
...
<div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" method="POST" action="CargarImagenCliente.php" enctype="multipart/form-data" autocomplete="off">
    ...
    if ($_POST["BTN_INGRESAR"]) {
        ...
        $update="UPDATE clientes SET imagen='$destino' WHERE id='$idSlider'";
