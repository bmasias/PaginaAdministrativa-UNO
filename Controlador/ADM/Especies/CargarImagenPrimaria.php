...
<div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" method="POST" action="CargarImagenPrimaria.php" enctype="multipart/form-data" autocomplete="off">
    ...
    if ($_POST["BTN_INGRESAR"]) {
        ...
        $update="UPDATE especies SET imagen1='$destino' WHERE id='$idEspecie'";
