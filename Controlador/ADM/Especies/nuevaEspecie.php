          ...
          <div class="col-lg-12">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">NUEVA ESPECIE</h1>
              </div>
              <form class="user" method="POST" action="nuevaEspecie.php">
                <div class="form-group row">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user"  name="txt_titulo" placeholder=" Ingrese Titulo" required="" >
                  </div> 
                </div>
                <input type="submit" name="BTN_INGRESAR" value="REGISTRAR ESPECIE" class="btn btn-primary btn-user btn-block">
                <hr>
        ...
        <?php 
            ...
            if ($_POST["BTN_INGRESAR"]) {
              ...
              $titulo=$_POST["txt_titulo"];
                ...
                $insert="INSERT INTO especies VALUES(NULL,'$titulo',NULL,NULL,NULL,NULL,NOW(),NULL,NULL,NULL,'Activo')";
                $ejecutar_insert=mysqli_query($con,$insert);

                if ($ejecutar_insert) {
                    echo "<div class='alert alert-success alert-dismissible fade show' role='alert'>
                        <strong>ESPECIE CREADA  CORRECTAMENTE
