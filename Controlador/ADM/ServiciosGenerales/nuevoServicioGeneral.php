      ...
      <div class="card-body p-0">
          ...
          <div class="col-lg-12">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">CREAR NUEVO SERVICIO GENERAL</h1>
              </div>
              <form class="user" method="POST" action="nuevoServicioGeneral.php" >
        ...
        <?php 
            ...
            if ($_POST["BTN_INGRESAR"]) {
              ...
              $insertar="INSERT INTO servicios_generales VALUES(null,'$titulo','$parrafo',null,null,null,NOW(),null,null,'Activo')";
