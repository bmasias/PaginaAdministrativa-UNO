...
<div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" method="POST" action="CargarImagenSerTerreno.php" enctype="multipart/form-data" autocomplete="off">
    ...
    if ($_POST["BTN_INGRESAR"]) {
        ...
        $update="UPDATE servicios_terreno SET imagen='$destino' WHERE id='$idSlider'";
