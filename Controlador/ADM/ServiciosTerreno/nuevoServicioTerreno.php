      ...
      <div class="card-body p-0">
          ...
          <div class="col-lg-12">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">CREAR NUEVO SERVICIO TERRENO</h1>
              </div>
              <form class="user" method="POST" action="nuevoServicioTerreno.php" >
                  ...
                  <div class="col-sm-8 mb-3 mb-sm-0">
                   ...
                   <div class="col-sm-4 mb-3 mb-sm-0">
                    <select class="form-control " name="cbo_destacado">
                      <option disabled="" selected="">SELECCIONE SI ES DESTACADO</option>
                ...
                <input type="submit" name="BTN_INGRESAR" value="REGISTRAR SERVICIO" class="btn btn-primary btn-user btn-block">
                <hr>
        ...
        <?php 
            ...
            if ($_POST["BTN_INGRESAR"]) {
              ...
              $insertar="INSERT INTO servicios_terreno VALUES(null,'$titulo',null,null,'$parrafo','$destacado',null,null,null,NOW(),null,null,'Activo')";
              $resultadoInsert=mysqli_query($con,$insertar);

              		if ($resultadoInsert) {
            				echo "<div class='alert alert-success alert-dismissible fade show' role='alert'>
            					  <strong>SERVICIO CREADO CORRECTAMENTE
