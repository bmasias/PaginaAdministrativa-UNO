            ...
            <div class="card-header py-3">
              <div class="row">
                <div class="col">
                 ...
                 <div class="col">
                  <a href="Clientes/nuevoCliente.php" class="btn btn-primary">NUEVO CLIENTES</a>
                </div>
              </div>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php 
                    $listar="SELECT * FROM clientes WHERE estado='Activo'";
                  ...
                  ?>
                    <tr>
                     ...
                     <td><a href="Clientes/CargarImagenCliente.php?id=<?php echo $ver["id"];?>"><img src="../img/img.png"></a></td>
                      <td><a href="Clientes/EliminarCliente.php?id=<?php echo $ver["id"];?>" onclick="return confirm('Confirma que deseas borrar este registro.');"><img src="../img/eli.png"></a></td>
                    </tr>
                  <?php }//cierra while?>
                </table>
              </div>
